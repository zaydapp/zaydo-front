                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <Badge
                        variant={getStatusBadgeVariant(
                          product.currentStock <= 0 ? 'OUT_OF_STOCK' : 'LOW'
                        )}
                      >
                        {t(
                          `inventory.status.${product.currentStock <= 0 ? 'out_of_stock' : 'low'}`
                        )}
                      </Badge>
                    </div>
                    <div className="text-sm text-muted-foreground space-y-1">
                      <div>
                        ...
                        <span className="font-medium">{product.currentStock}</span> {product.unit} |{' '}
                        {t('inventory.minStock')}:{' '}
                        <span className="font-medium">{product.minStock}</span> {product.unit}
