                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <Input
                        ...
                        placeholder={
                          t('invoices.paymentTermsPlaceholder') ||
                          'Ex: Net 30, Paiement à réception'
                        }
                        className="mt-1.5"
                      />
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        placeholder={
                          t('invoices.termsPlaceholder') ||
                          'Ajouter des conditions pour cette facture'
                        }
                        rows={4}
                        className="mt-1.5 resize-none"
                      />
          ...
          <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{format(invoice.taxAmount ?? 0)}</span>
                  </div>
                  <Separator />
                  <div className="flex items-center justify-between text-lg font-semibold">
                    <span>{t('invoices.totalDue') || 'Total Due'}</span>
                    <span>{format(invoice.totalAmount ?? 0)}</span>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {t('invoices.metaDesc') || 'Dates, payment terms & notes'}
                </CardDescription>
              </CardHeader>
